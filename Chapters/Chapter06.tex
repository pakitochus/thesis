...
\ac{LBP} was devised to describe the texture of a image, with an initial application to face recognition. Later, it was extended to Volumetric \ac{LBP}, in which the texture 
% DONE
