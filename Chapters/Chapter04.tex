...
\begin{figure}[bth]
	...
	\caption[Original PET image and its reconstruction using FA or ICA.]{Original PET image from the \adnipet{} dataset, and examples of reconstruction using \ac{FA} or \ac{ICA}, with 10 components.}\label{fig:comparisonReconstructions}
\end{figure}
