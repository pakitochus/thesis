...
\begin{table}
	\begin{tabularx}{\linewidth}{Xllccc}
		\tableheadline{DB} & \tableheadline{Dec.} & \tableheadline{Criterion} & \tableheadline{Accuracy} & \tableheadline{Sensitivity} & \tableheadline{Specificity}\\
		\toprule
		\multirow{7}{1.7cm}{PPMI-DAT} & \ac{VAF} & - & $0.922 \pm 0.062$ & $0.900 \pm 0.094$ & $0.958 \pm 0.085$ \\
		\cline{2-6}
...
The selected areas on these \ac{CAD} systems correspond to the highlighted areas in Figure~\ref{fig:comparisonSelection_adnipet}, in the case of ADNI-PET dataset. These areas correspond fundamentally to 
...
Similar areas are highlighted in the VDLN-HMPAO.
