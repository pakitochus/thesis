...
\begin{figure}[bth]
	...
	\caption[Original PET image and its reconstruction using FA or ICA.]{Original PET image from the ADNI-PET dataset, and its reconstruction using \ac{FA} or \ac{ICA}, using 10 components.}\label{fig:comparisonReconstructions}
\end{figure}
