...
Considering that the values of $\mathbf{w}$ converge when their dot product is close to 1. 



% HASTA AQUI BIEN
By a "unit" we refer to a computational unit, eventually an artificial neuron, hthis is then defined as: 
