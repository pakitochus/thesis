...
\caption[Location of the significant region labelled D (posterior part of the superior temporal gyrus) within the \acs{MNI} template.]{Location of the significant region labelled D (posterior part of the superior temporal gyrus) within the \acs{MNI} template.}
\label{fig:figure06}
\end{figure}
