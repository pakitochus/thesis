...
%************************************************
We will propose many analysis techniques and \ac{CAD} systems throughout this thesis. We will apply them to many experiments, and use similar data and techniques in them. In this chapter, we will focus on the methodology that is common to most of these experiments, particularly focusing on preprocessing and evaluation of our systems. 
