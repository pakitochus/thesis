%*****************************************
\chapter{State of the Art}\label{ch:medicine}
%*****************************************
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.7\linewidth]{gfx/ch1/example_SPECT}\\
	\includegraphics[width=0.7\linewidth]{gfx/ch1/example_DaTSCAN}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=\linewidth]{gfx/ch1/example_SPM}
