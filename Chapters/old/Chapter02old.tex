...
We try the following acronym \ac{PCA}. The next time we use \ac{PCA}, it dissappears 

It can be found in \ac{SPM}. The package \ac{SPM} can be of great importance in several things. 
