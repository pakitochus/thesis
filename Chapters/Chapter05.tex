...
In \cite{Haralick73}, twelve texture features are derived from the probability matrix. These features are noted as:
...
\begin{figure*}% single and cumulative approach. 
	\centering
	\subfloat[Single approach]{\includegraphics[width=0.45\textwidth]{Graphics/ch5/featuresIthdis.eps}\label{fig:acc_dist}}
	\subfloat[Cumulative approach]{\includegraphics[width=0.45\textwidth]{Graphics/ch5/featuresIthcum.eps}\label{fig:acc_cum}}
